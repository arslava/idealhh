...
// This component renders on a Russian-language page, but the source data
// confirms the actual embedded form is WPForms id 2466 ("Contact Us") — the
// same English-labeled form used on the English site, not the separate
// "Contact Us (RU)" form (id 2504). Verified directly from the page's own
// contact_banner_form shortcode in the SQL dump: [wpforms id="2466"].
// Per explicit instruction, matching source exactly: field labels below are
// the real English labels from form 2466, not translated.
const LANGUAGES = [
