...
// Real review content from the original site's ideal_reviews carousel —
// appears on both the homepage and /enroll-now/ in the source.
export default function ReviewsCarousel() {
  const { reviewsSection } = homePage;
