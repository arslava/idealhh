...
import { navZhHant, siteZhHant } from "@/lib/nav.zh-hant";
import LanguageSwitcher from "./LanguageSwitcher";

export default function HeaderZhHant() {
    ...
    <header className="o-header relative z-50">
      <div className="border-b border-navy-muted/20 py-3">
        <div className="mx-auto max-w-[1140px] px-4 flex items-center justify-between gap-6">
          <div className="text-grey-800">
            <span className="text-[1.25rem] font-semibold text-navy-muted mr-2">立即致電我們！</span>
            <a href={siteZhHant.phoneHref} className="text-[1.25rem] font-black text-navy-700 hover:text-accent">
              {siteZhHant.phone}
            </a>
          </div>
      ...
      <div className="shadow-[0_20px_40px_rgba(56,75,116,0.1)] py-6">
        <div className="mx-auto max-w-[1140px] px-4 flex items-center justify-between gap-8">
          <Link href="/zh-hant" className="shrink-0">
            <Image src="/images/logo.svg" alt={siteZhHant.name} width={186} height={59} priority className="h-10 w-auto md:h-12" />
          </Link>
