...
// Confirmed via live fetch of /es/carreras/ — same underlying WPForms
// caregiver-application form as EN/RU (job application with certification
// type, availability, and address fields), but with two genuine partial
// translations not present on EN/RU: the city field label ("Ciudad") and
// the full State dropdown, which uses real Spanish state names. Everything
// else on this form stays in English, matching source.
// CDPAP button (present in source alongside "Patient Enrollment") dropped
// per standing rule.
// A stray "What Caregiver Campaign" field appeared in the fetch between
// Last Name and Email — like the other forms' stray fields, this looks
// like a hidden tracking field rather than a real user-facing one; omitted
...
const STATES = [
  ...
  "Delaware", "Distrito de Columbia", "Florida", "Georgia", "Hawai", "Idaho", "Illinois",
  ...
  "Nuevo Hampshire", "Nueva Jersey", "Nuevo México", "Nueva York", "Carolina del norte",
  "Dakota del norte", "Ohio", "Oklahoma", "Oregón", "Pensilvania", "Rhode Island",
  "Carolina del Sur", "Dakota del Sur", "Tennessee", "Texas", "Utah", "Vermont", "Virginia",
  "Washington", "Virginia Occidental", "Wisconsin", "Wyoming",
];

export default function CaregiverApplicationFormEs() {
  ...
  if (status === "success") {
    return (
      <div className="text-center py-8">
        <p className="text-xl font-semibold text-navy-800">¡Gracias por postularte!</p>
        <p className="mt-2 text-grey-800">Un miembro de nuestro equipo se pondrá en contacto pronto.</p>
      </div>
    );
  }
  ...
  return (
    <form onSubmit={handleSubmit} className="text-left space-y-5">
      ...
      <div className="grid grid-cols-2 gap-4">
        <FloatingInput id="city" name="city" label="Ciudad" />
        <div>
