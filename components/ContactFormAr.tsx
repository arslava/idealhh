...
// Confirmed via live fetch of /ar/contact-us-2/ — same English field
// labels as the EN/RU/ES versions (First Name, Last Name, Email, Phone,
// Message, Preferred Language, same SMS opt-in text). A stray "UTM Last
// Medium" field appeared near Submit — like the other forms' stray
  ...
  if (status === "success") {
    return (
      <div className="text-center py-8">
        <p className="text-xl font-semibold text-navy-800">شكراً لتواصلك معنا!</p>
        <p className="mt-2 text-grey-800">لقد تلقينا رسالتك وسنتواصل معك قريباً.</p>
      </div>
    );
  }
