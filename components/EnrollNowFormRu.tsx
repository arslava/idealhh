...
// This renders on a Russian-language page, but the source data confirms the
// actual embedded form is WPForms id 2688 ("Patient Enrollment") — the same
// English-labeled form used on the English site, not the separate "Enroll
// Today Form (RU)" (id 2506). Verified directly from the page's own
// contact_banner_form shortcode: [wpforms id="2688"]. Field 45 in that form
// is an HTML block containing the "*This is a Patient Application ONLY*"
// note and a "Become a Caregiver" button — both reproduced below since
// they're real content on the actual embedded form, not assumptions.
const LANGUAGES = [
  "English", "Spanish", "Russian", "French", "Haitian Creole", "Cantonese",
  "Mandarin", "Arabic", "Hindi", "Urdu", "Albanian", "Armenian", "Bengali",
  "Burmese", "Cantonese", "Korean", "Italian", "Indonesian", "Nepali", "Punjabi",
];
...
export default function EnrollNowFormRu() {
  ...
  return (
    <form onSubmit={handleSubmit} className="text-left space-y-5">
      <p className="text-center font-semibold text-accent">*This is a Patient Application ONLY*</p>
