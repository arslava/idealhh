...
// Confirmed via live fetch of /zh-hant/contact-us-2/ — same English field
// labels as the EN/RU/ES/AR versions. A stray "GCLID Opt Campaign" field
// appeared near Submit — like the other forms' stray fields, this looks
// like a hidden tracking field rather than a real user-facing one;
...
export default function ContactFormZhHant() {
  ...
  if (status === "success") {
    return (
      <div className="text-center py-8">
        <p className="text-xl font-semibold text-navy-800">感謝您與我們聯繫！</p>
        <p className="mt-2 text-grey-800">我們已收到您的訊息，將盡快與您聯繫。</p>
      </div>
    );
  }
