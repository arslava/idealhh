...
import { arReviewsSection } from "@/lib/content.ar";

export default function ReviewsCarouselAr() {
  return (
          ...
          {arReviewsSection.reviews.map((r) => (
            ...
            >
              ...
              <div className="mt-4">
                ...
                <p className="text-sm text-navy-muted" dir="ltr">{r.date}</p>
              </div>
            </div>
          ))}
        </div>
