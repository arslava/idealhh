...
// Confirmed via live fetch of /zh-hant/enroll-now/ — same English field
// labels as the EN form. A stray "Name Opt Term" field appeared near
// Submit — like the other forms' stray fields, omitted pending confirmation.
const LANGUAGES = [
...
export default function EnrollNowFormZhHant() {
  ...
  if (status === "success") {
    return (
      <div className="text-center py-8">
        <p className="text-xl font-semibold text-navy-800">感謝您的關注！</p>
        <p className="mt-2 text-grey-800">我們的團隊成員將盡快與您聯繫，協助您開始使用服務。</p>
      </div>
    );
  }
