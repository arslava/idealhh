...
// Confirmed via live fetch of /ar/enroll-now/ — same English field labels
// as the EN form (First Name, Last Name, Email, Phone, Medicaid ID,
// Preferred Language, SMS opt-in). A stray "ID Language Name" field
// appeared near Submit — like the other forms' stray fields, omitted
...
export default function EnrollNowFormAr() {
  ...
  if (status === "success") {
    return (
      <div className="text-center py-8">
        <p className="text-xl font-semibold text-navy-800">شكراً لاهتمامك!</p>
        <p className="mt-2 text-grey-800">سيتواصل معك أحد أعضاء فريقنا قريباً لمساعدتك على البدء.</p>
      </div>
    );
  }
