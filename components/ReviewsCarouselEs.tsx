...
import { esReviewsSection } from "@/lib/content.es";

// Spanish version of ReviewsCarousel — same 8 reviews (translated to
// Spanish in the source, confirmed via live fetch of the /es/ homepage),
// same layout as the English component.
export default function ReviewsCarouselEs() {
  return (
        ...
        <div className="mt-10 flex gap-6 overflow-x-auto pb-4 snap-x snap-mandatory -mx-4 px-4 md:mx-0 md:px-0">
          {esReviewsSection.reviews.map((r) => (
            ...
            >
              ...
              <p className="mt-3 text-[1.0625rem] text-grey-800 leading-relaxed flex-1 whitespace-pre-line">{r.content}</p>
              <div className="mt-4">
