    ...
    <>
      <section className="bg-navy text-paper">
        <div className="mx-auto max-w-6xl px-6 pt-16 pb-20 md:pt-20 md:pb-24">
          <p className="text-sky text-sm font-semibold tracking-[0.2em] uppercase">Services</p>
      ...
      <section className="mx-auto max-w-6xl px-6 py-16 grid md:grid-cols-2 gap-8">
        {services.map((service) => (
          <div key={service.title} className="rounded-3xl border border-navy/10 bg-white overflow-hidden">
