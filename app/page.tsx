    ...
    <>
      ...
      <section className="bg-navy-900 text-white">
        <div className="mx-auto max-w-[1140px] px-4 grid lg:grid-cols-2 gap-10 items-center">
          <div className="py-16 lg:py-20">
            <h1 className="font-display text-4xl md:text-5xl lg:text-[3.5rem] leading-[1.1] font-medium">
              {hero.titlePrefix}
              <span className="text-accent">{hero.highlight}</span>
              {hero.titleSuffix}
            </h1>
            <p className="mt-6 max-w-xl text-white/80 leading-relaxed">{hero.description}</p>
          ...
          {servicesTeaser.map((service) => {
            ...
            return (
              ...
              >
                ...
                <h3 className="font-display text-2xl font-semibold text-navy-800">{service.title}</h3>
                <p className="mt-4 text-navy-muted leading-relaxed">{service.description}</p>
      ...
      <section className="mx-auto max-w-[1140px] px-4 py-20 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div>
          ...
          <h2 className="mt-3 font-display text-3xl md:text-4xl font-black text-navy-800">{whoBenefits.title}</h2>
      ...
      <section className="bg-bg-light">
        <div className="mx-auto max-w-[1140px] px-4 py-20 grid md:grid-cols-2 gap-12 items-center">
          ...
          <div className="order-1 md:order-2">
            ...
            <h2 className="mt-3 font-display text-3xl md:text-4xl font-black text-navy-800">{customPlans.title}</h2>
      ...
      <section className="relative bg-gradient-to-b from-white to-bg-light overflow-hidden">
        <div className="mx-auto max-w-[1140px] px-4 py-20 relative">
          ...
          <div className="max-w-xl relative">
            ...
            <p className="mt-4 text-grey-800 leading-relaxed">{locations.description}</p>
      ...
      <section className="mx-auto max-w-[1140px] px-4 py-20 grid md:grid-cols-2 gap-12 items-center">
        <div>
          ...
          <h2 className="mt-3 font-display text-3xl md:text-4xl font-black text-navy-800">{careers.title}</h2>
          <p className="mt-4 text-grey-800 leading-relaxed">{careers.description}</p>
