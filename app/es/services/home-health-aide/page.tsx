    ...
    <>
      ...
      <section className="mx-auto max-w-[1140px] px-4 py-20 grid md:grid-cols-2 gap-12 items-center">
        ...
        <div className="order-1 md:order-2">
          <h2 className="font-display text-3xl md:text-4xl font-semibold text-navy-800">
            {gettingCare.title.replace(gettingCare.highlight, "")}<span className="text-accent italic">{gettingCare.highlight}</span>
          </h2>
      ...
      <section className="bg-bg-light">
        <div className="mx-auto max-w-[1140px] px-4 py-16">
          ...
          {/* Intro sentence before the bullets — present in this ES page but
              not on the EN version (see note in content.es.ts). */}
