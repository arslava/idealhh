...
export default function EsHome() {
  const { hero, servicesTeaser, whoBenefits, customPlans, locations, careers, prefooterCta, heroImage, locationsImage, locationCards } = esHomePage;
        ...
        <div className="mx-auto max-w-[1140px] px-4 grid lg:grid-cols-2 gap-10 items-stretch">
          <div className="py-16 lg:py-20">
            <h1 className="font-display text-[2.8125rem] md:text-[4.0625rem] lg:text-[5.625rem] leading-[1.05] font-medium">
              {hero.titlePrefix}<span className="text-accent">{hero.highlight}</span>{hero.titleSuffix}
            </h1>
          ...
          <div className="relative min-h-[320px] h-full lg:-mr-4">
            <Image
              src={heroImage}
              alt="Servicios de atención médica domiciliaria con compasión en la ciudad de Nueva York"
              fill
              priority
