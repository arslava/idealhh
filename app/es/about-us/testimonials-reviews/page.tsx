...
export default function EsTestimonialsReviewsPage() {
  const { hero, testimonialsLabel, testimonials, reviewsLabel, reviews, prefooterCta } = esTestimonialsPage;
    ...
    <>
      <section className="bg-bg-light">
        <div className="mx-auto max-w-[840px] px-4 py-16 text-center">
          ...
          {/* Genuinely untranslated second heading in the source — see note in content.es.ts */}
