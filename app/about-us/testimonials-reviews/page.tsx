    ...
    <>
      <section className="bg-bg-light">
        <div className="mx-auto max-w-[840px] px-4 py-16 text-center">
          ...
          <p className="mt-4 text-grey-800 leading-relaxed max-w-2xl mx-auto">{hero.description}</p>
        </div>
      </section>

      <section className="mx-auto max-w-[1140px] px-4 py-16">
        <h2 className="font-display text-2xl font-semibold text-navy-800 text-center">Testimonials</h2>
        <div className="mt-8 grid md:grid-cols-3 gap-6">
          {testimonials.map((t) => (
            <div key={t.author} className="rounded-3xl bg-white border border-navy-900/10 shadow-[0_20px_40px_rgba(56,75,116,0.06)] p-6 flex flex-col">
              <Stars rating={t.rating} />
              <p className="mt-4 text-grey-800 leading-relaxed flex-1">&ldquo;{t.content}&rdquo;</p>
              <div className="mt-4">
      ...
      <section className="bg-bg-light">
        <div className="mx-auto max-w-[1140px] px-4 py-16">
          <h2 className="font-display text-2xl font-semibold text-navy-800 text-center">Reviews</h2>
          <div className="mt-8 grid md:grid-cols-2 gap-6">
            {reviews.map((r) => (
              <div key={r.name} className="rounded-3xl bg-white border border-navy-900/10 shadow-[0_20px_40px_rgba(56,75,116,0.06)] p-6">
                <Stars rating={r.rating} />
                <p className="mt-3 text-grey-800 leading-relaxed">{r.review}</p>
