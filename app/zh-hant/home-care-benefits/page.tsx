...
import { zhHantBenefitsPage } from "@/lib/content.zh-hant";
import { buildMetadata } from "@/lib/metadata";

export const metadata = buildMetadata({
  key: "homeCareBenefits",
  locale: "zhHant",
  title: "Medicaid 與 Medicare 承保的居家照護福利 | Ideal Home Health",
  description: "了解您或家人是否符合資格，透過 Medicaid 與 Medicare 在紐約市免費獲得居家照護服務。",
});

export default function ZhHantBenefitsPage() {
  const { hero, qualify, included, includedImage, extras, stepsImage, steps, whyChoose, locations, officeCards, quote, prefooterCta } = zhHantBenefitsPage;
        ...
        <div className="mx-auto max-w-[1140px] px-4 grid lg:grid-cols-2 gap-10 items-stretch">
          <div className="py-16 lg:py-20">
            ...
            <div className="mt-8 flex flex-wrap items-center gap-6">
              ...
              <a href="tel:7185172424" className="text-accent font-semibold">立即致電我們！{hero.phone}</a>
            </div>
          </div>
