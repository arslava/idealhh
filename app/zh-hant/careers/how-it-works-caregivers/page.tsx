...
import { zhHantBecomeCaregiverPage } from "@/lib/content.zh-hant";
import { buildMetadata } from "@/lib/metadata";

export const metadata = buildMetadata({
  key: "becomeACaregiver",
  locale: "zhHant",
  title: "成為 Ideal Home Health 看護人員 | 紐約",
  description: "了解如何申請成為 Ideal Home Health 的家庭護理助理：申請流程、背景調查，以及與合適患者的配對。",
});

export default function ZhHantBecomeCaregiverPage() {
  const { hero, steps, stepsImage, gettingStarted, prefooterCta } = zhHantBecomeCaregiverPage;
    ...
    <>
      ...
      <section className="mx-auto max-w-[1140px] px-4 py-20 grid lg:grid-cols-2 gap-12 items-center">
        <div className="relative rounded-[49px] overflow-hidden aspect-[4/3] order-2 lg:order-1">
          <Image src={stepsImage} alt="看護人員申請流程" fill className="object-cover" />
        </div>
      ...
      <section className="bg-bg-light">
        <div className="mx-auto max-w-[1140px] px-4 py-20 grid lg:grid-cols-2 gap-12 items-center">
          ...
          <div>
            ...
            {/* Extra subtitle line unique to this ZH-HANT page — genuinely
                present in the source, matching the same quirk found on ES/AR */}
