...
import CaregiverApplicationFormZhHant from "@/components/CaregiverApplicationFormZhHant";
import { zhHantCareersPage } from "@/lib/content.zh-hant";
import { buildMetadata } from "@/lib/metadata";

export const metadata = buildMetadata({
  key: "careers",
  locale: "zhHant",
  title: "紐約家庭護理助理職缺 | Ideal Home Health",
  description: "加入 Ideal Home Health 團隊，成為家庭護理助理 (HHA)、護理師或 PCA。提供有競爭力的薪資與彈性排班，服務範圍涵蓋布魯克林與布朗克斯。",
});

export default function ZhHantCareersPage() {
  const { hero, benefits, qualify, locations, officeCards, jobs } = zhHantCareersPage;
  return (
    <>
      ...
      <section id="qualifyenroll" className="bg-navy-900 text-white">
        <div className="mx-auto max-w-[1140px] px-4 py-16 grid md:grid-cols-2 gap-8 items-start">
          ...
          <div className="rounded-[10px] bg-white p-8">
            ...
            <CaregiverApplicationFormZhHant />
          </div>
        </div>
      </section>
