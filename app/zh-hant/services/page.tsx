...
import { zhHantServicesPage } from "@/lib/content.zh-hant";
import { buildMetadata } from "@/lib/metadata";

export const metadata = buildMetadata({
  key: "services",
  locale: "zhHant",
  title: "紐約居家護理服務 | Ideal Home Health",
  description: "受過培訓的家庭護理助理與持證訪視護士，於紐約市為患者提供貼心、個人化的護理服務，服務範圍涵蓋布魯克林與布朗克斯。",
});

export default function ZhHantServicesPage() {
  const { hero, services, whyChoose, prefooterCta } = zhHantServicesPage;
