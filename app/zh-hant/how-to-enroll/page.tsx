...
import { zhHantHowToEnrollPage } from "@/lib/content.zh-hant";
import { buildMetadata } from "@/lib/metadata";

export const metadata = buildMetadata({
  key: "howToEnroll",
  locale: "zhHant",
  title: "如何註冊居家護理服務 | Ideal Home Health",
  description: "了解在紐約與 Ideal Home Health 註冊成為病患的完整流程：確認 Medicaid 資格、進行評估，並配對合適的護理員。",
});

export default function ZhHantHowToEnrollPage() {
  const { hero, steps, bullets, prefooterCta } = zhHantHowToEnrollPage;
