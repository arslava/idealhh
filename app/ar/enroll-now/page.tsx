...
import EnrollNowFormAr from "@/components/EnrollNowFormAr";
import ReviewsCarouselAr from "@/components/ReviewsCarouselAr";
import { arEnrollNowPage } from "@/lib/content.ar";
import { buildMetadata } from "@/lib/metadata";

export const metadata = buildMetadata({
  key: "enrollNow",
  locale: "ar",
  title: "سجل اليوم | الرعاية المنزلية في نيويورك | Ideal Home Health",
  description: "تعرف على ما إذا كنت أنت أو أحد أفراد أسرتك مؤهلاً للحصول على رعاية منزلية عبر Medicaid أو Medicare، وسجل اليوم مع Ideal Home Health في نيويورك.",
});

export default function ArEnrollNowPage() {
  const { heroTitle, patientSection, caregiverSection, formSection, prefooterCta } = arEnrollNowPage;
  return (
    <>
          ...
          <div className="flex flex-col-reverse md:flex-row gap-10 items-start">
            ...
            <div className="md:w-1/2 flex justify-center">
              <div className="w-full max-w-[510px] rounded-[10px] bg-white shadow-[0_20px_40px_rgba(56,75,116,0.1)] p-11 text-left">
                ...
                <div className="mt-6"><EnrollNowFormAr /></div>
              </div>
            </div>
          </div>
        </div>
