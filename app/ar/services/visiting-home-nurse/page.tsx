...
import { arVisitingHomeNursePage, arTestimonialsPage } from "@/lib/content.ar";
import { buildMetadata } from "@/lib/metadata";

export const metadata = buildMetadata({
  key: "visitingHomeNurse",
  locale: "ar",
  title: "ممرضة منزلية زائرة في نيويورك | Ideal Home Health",
  description: "ممرضات مسجلات ومرخصات يضعن خطة رعاية مخصصة لك، مع مراقبة حالتك الصحية في منزلك في نيويورك.",
});
...
export default function ArVisitingHomeNursePage() {
  const { hero, bullets, testimonialsLabel, prefooterCta } = arVisitingHomeNursePage;
  const testimonials = arTestimonialsPage.testimonials;
