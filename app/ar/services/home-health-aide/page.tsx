...
import { arHomeHealthAidePage } from "@/lib/content.ar";
import { buildMetadata } from "@/lib/metadata";

export const metadata = buildMetadata({
  key: "homeHealthAide",
  locale: "ar",
  title: "مساعدو الصحة المنزلية (HHA) في نيويورك | Ideal Home Health",
  description: "مساعدون صحيون منزليون معتمدون من وزارة الصحة، يتلقون تدريباً نصف سنوي على السلامة. رعاية شخصية ومساعدة يومية في بروكلين وبرونكس.",
});

export default function ArHomeHealthAidePage() {
  const { hero, gettingCare, howTheyHelp, prefooterCta } = arHomeHealthAidePage;
    ...
    <>
      ...
      <section className="bg-bg-light">
        <div className="mx-auto max-w-[1140px] px-4 py-16">
          ...
          <p className="mt-4 text-[1.125rem] text-grey-800 max-w-2xl">{howTheyHelp.intro}</p>
