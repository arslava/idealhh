...
import { arHowToEnrollPage } from "@/lib/content.ar";
import { buildMetadata } from "@/lib/metadata";

export const metadata = buildMetadata({
  key: "howToEnroll",
  locale: "ar",
  title: "كيفية التسجيل في الرعاية المنزلية | Ideal Home Health",
  description: "تعرف على عملية التسجيل خطوة بخطوة كمريض مع Ideal Home Health في نيويورك: التحقق من Medicaid والتقييم وتعيين مقدم رعاية.",
});

export default function ArHowToEnrollPage() {
  const { hero, steps, bullets, prefooterCta } = arHowToEnrollPage;
