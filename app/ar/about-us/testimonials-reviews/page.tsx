...
import { arTestimonialsPage } from "@/lib/content.ar";
import { buildMetadata } from "@/lib/metadata";

// Real title confirmed via live fetch. The live meta-description is just
// the short "الرفقة في بروكلين، نيويورك" (matches the on-page secondary
// heading) — too thin for search results, so a real descriptive one is
// used here instead, same approach already taken for ES.
export const metadata = buildMetadata({
  key: "testimonials",
  locale: "ar",
  title: "الشهادات والمراجعات - Ideal Home Health",
  description: "اقرأ شهادات ومراجعات حقيقية من مرضى ومقدمي رعاية وعائلات عن تجربتهم مع Ideal Home Health، وكالة الرعاية المنزلية الموثوقة في نيويورك.",
});
...
export default function ArTestimonialsReviewsPage() {
  const { hero, testimonialsLabel, testimonials, reviewsLabel, reviews, prefooterCta } = arTestimonialsPage;
