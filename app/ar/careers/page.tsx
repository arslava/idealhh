...
import CaregiverApplicationFormAr from "@/components/CaregiverApplicationFormAr";
import { arCareersPage } from "@/lib/content.ar";
import { buildMetadata } from "@/lib/metadata";

export const metadata = buildMetadata({
  key: "careers",
  locale: "ar",
  title: "وظائف مساعد الصحة المنزلية في نيويورك | Ideal Home Health",
  description: "انضم إلى فريق Ideal Home Health كمساعد صحي منزلي (HHA) أو ممرض أو PCA. رواتب تنافسية وجداول عمل مرنة في بروكلين وبرونكس.",
});

export default function ArCareersPage() {
  const { hero, benefits, qualify, locations, officeCards, jobs } = arCareersPage;
  return (
    <>
